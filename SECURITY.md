...
- Session limited: 20 questions per session (enforced server-side)
...
**Location**: [Auth Settings](https://supabase.com/dashboard/project/tjwxjelotksrqzaqulbp/auth/providers)
...
**Location**: [Database Settings](https://supabase.com/dashboard/project/tjwxjelotksrqzaqulbp/settings/database)
...
1. Revoke access in Supabase Dashboard → Auth → Users
