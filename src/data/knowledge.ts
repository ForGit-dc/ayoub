...
export const suggestedQA = [
  ...
  },
  {
    ...
    answer_en: "At Opinion Science I replaced an hourly batch architecture with a real-time Apache Kafka orchestration and cut estimated LLM annotation from about 83 hours to about 8 hours on a 203,456-segment corpus, through clustering-first annotation (UMAP + HDBSCAN + GPT-4o). At INED I structured a longitudinal dataset following 18,000+ children over 10 years and modeled mental-health determinants with logistic regression. I optimize for cost, reliability and scale, not just accuracy.",
    answer_fr: "Chez Opinion Science, j’ai remplacé une architecture batch horaire par une orchestration temps réel Apache Kafka et réduit l’annotation LLM estimée d’environ 83 heures à environ 8 heures sur un corpus de 203 456 segments, grâce à une annotation par clustering (UMAP + HDBSCAN + GPT-4o). À l’INED, j’ai structuré un jeu de données longitudinal suivant 18 000+ enfants sur 10 ans et modélisé les déterminants de la santé mentale par régression logistique. J’optimise le coût, la fiabilité et le passage à l’échelle, pas seulement la précision."
  },
  {
    id: "why_hire",
    ...
    answer_en: "Because I industrialize data pipelines end to end, not just notebooks. I built a cloud-native ingestion pipeline on GCP with an Apache Kafka bus and a semantic clustering pipeline that cut LLM annotation from about 83 hours to about 8 hours. I pair data engineering (GCP, AWS, Terraform, Docker, CI/CD) with real statistical rigor (ENSAI, and longitudinal modeling on 18,000+ children at INED), I am a DataCamp-certified Data Engineer, and I am immediately available.",
    answer_fr: "Parce que j’industrialise les pipelines de données de bout en bout, pas juste des notebooks. J’ai construit un pipeline d’ingestion cloud-native sur GCP avec un bus Apache Kafka et un pipeline de clustering sémantique qui a réduit l’annotation LLM d’environ 83 heures à environ 8 heures. J’allie l’ingénierie des données (GCP, AWS, Terraform, Docker, CI/CD) et une vraie rigueur statistique (ENSAI, et de la modélisation longitudinale sur 18 000+ enfants à l’INED), je suis certifié Data Engineer par DataCamp, et je suis disponible immédiatement."
  },
  {
    id: "cloud_stack",
