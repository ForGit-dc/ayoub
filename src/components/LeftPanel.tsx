...
import { Linkedin, Mail, ExternalLink, User, Edit3, X, Globe } from "lucide-react";
...
export const LeftPanel = memo(function LeftPanel({
  ...
  const displayName = lang === "ar" ? "أيوب اليانبوي" : "Ayoub El Yanboiy";
    ...
    <div className="flex flex-col space-y-4">
      ...
      <nav aria-label="Profile links" className="space-y-2">
        <Button asChild variant="outline" className="w-full justify-start">
          <a href="https://www.linkedin.com/in/ayoub-el-yanboiy" target="_blank" rel="noopener noreferrer">
