...
export const PROFILE_NAME_EN = "Ayoub El Yanboiy";
export const PROFILE_NAME_FR = "Ayoub El Yanboiy";
export const PROFILE_NAME_AR = "أيوب اليانبوي"; // Correct Arabic name

// Translation resources
const RES = {
  en: {
    // Basic UI
    greeting: "Hi, I'm Ayoub. Ask me about my experience, projects, or skills.",
    settings: "Settings",
...
This only changes tone/length; facts still follow the knowledge base and guardrails.`,
    ...
    quickChips: {
      ...
      productionRigor: "Cloud pipeline project",
      timeSeriesExample: "LLM clustering",
  ...
  fr: {
    // Basic UI
    greeting: "Bonjour, je suis Ayoub. Posez vos questions sur mon parcours, mes projets ou mes compétences.",
    settings: "Paramètres",
...
Cela ne change pas les faits : le bot reste fidèle à la base de connaissances et aux garde-fous.`,
    ...
    quickChips: {
      intro30: "Intro 30 s",
      productionRigor: "Projet pipeline cloud",
      timeSeriesExample: "Clustering LLM",
  ...
  ar: {
    // Basic UI
    greeting: "مرحباً - أنا أيوب. اسألني عن خبرتي ومشاريعي ومهاراتي.",
    settings: "الإعدادات",
...
هذا يغير فقط النبرة/الطول؛ الحقائق تتبع قاعدة المعرفة والضوابط.`,
    ...
    quickChips: {
      ...
      productionRigor: "مشروع خط الأنابيب السحابي",
      timeSeriesExample: "تجميع عبر LLM",
