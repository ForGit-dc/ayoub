...
// (e.g. "Ayoub AI <alerts@yourdomain.com>") to lift the test-domain limits.
const FROM_EMAIL = Deno.env.get("ALERT_FROM_EMAIL") ?? "Ayoub AI <onboarding@resend.dev>";
...
async function maybeSendAlertEmail(args: {
  ...
  const subject = `[Ayoub AI] New question - ${displayName} (${lang || "n/a"})`;
